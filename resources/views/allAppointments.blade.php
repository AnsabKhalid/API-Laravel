...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Patient Appointments({{$patAppointments['patientId']}})</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
  ...
  <tbody>
    @for ($i = 0; $i < count($listAppointment); $i++)
      <tr>
          <td>{{ $i + 1 }}</td>
          <td>{{$listAppointment[$i]['clinicName']}}</td>
          <td>{{$listAppointment[$i]['serviceName']}}</td>
          <td>{{$listAppointment[$i]['appointmentDate']}}</td>
      </tr>
    @endfor
  </tbody>
  </table>
