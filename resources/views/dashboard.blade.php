  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <h6 style="color: aliceblue">{{$patInfo['patientName']}}</h6>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{url('allAppointments')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Patient Reports</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
         ...
         <div class="card-body table-responsive p-0">
          ...
          <tr>
              <th>Sr.</th>
              <th>cptDescription</th>
              <th>orderStatus</th>
              <th>invoiceDate</th>
          </tr>
        </thead>
        <tbody>
          @for ($i = 0; $i < count($patReports); $i++)
              <tr>
                  <td>{{ $i + 1 }}</td>
                  <td>{{ $patReports[$i]['cptDescription'] }}</td>
                  <td>{{ $patReports[$i]['orderStatus'] }}</td>
                  <td>{{ $patReports[$i]['invoiceDate'] }}</td>
              </tr>
          @endfor
        </tbody>
      </table>
